...
export const landingPages: LandingPageContent[] = [
  {
    ...
    phrases: [
      ...
      },
      {
        ...
        meaning: "Thank you",
        note: "Useful right away if you want practical restaurant confidence instead of generic food vocabulary lists.",
        audioSrc: "/marketing/audio/thank-you.wav",
      },
      {
        slug: "sillyehamnida",
        label: "Courtesy",
  ...
  },
  {
    ...
    phrases: [
      ...
      },
      {
        ...
        romanization: "yeyak",
        meaning: "Reservation",
        note: "One of those short hotel and arrival words that saves time immediately.",
        audioSrc: "/marketing/audio/reservation.wav",
      },
      {
        slug: "chekeu-in",
        label: "Hotel",
    ...
    phrases: [
      {
        ...
        romanization: "yeyak",
        meaning: "Reservation",
        note: "A short travel word that shows how phrase sets can stay practical without becoming a flat phrasebook.",
        audioSrc: "/marketing/audio/reservation.wav",
      },
      {
        slug: "chekeu-in",
        ...
        romanization: "chekeu in",
        meaning: "Check in",
        note: "A practical arrival phrase that makes it obvious why scene-based learning works.",
        audioSrc: "/marketing/audio/chekeu-in.wav",
      },
      {
        slug: "sillyehamnida",
